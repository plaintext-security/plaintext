...
<!-- AUTHOR'S NOTE (delete before publish): This module is deliberately structured against the
house template. There is no front-loaded "The core idea" essay; the bridge is delivered as
predict-then-reveal pairs the learner works *before* reading the answer, and again inside the lab at
each decision point. Learn is intentionally lean — a foundations module owns its spine rather than
outsourcing it to five links. See ../CHARTER-CRITIQUE.md for the reasoning. -->
