...
<!-- AUTHOR'S NOTE (delete before publish): Variant-D form. Module 02 proved one principal's reach by
hand; this module scales that to the whole account as a graph and makes the "minimum cut" a graph
operation you implement and re-run. The bridge arrives as a blast-radius prediction — given a menu of
innocuous-looking permissions, call which ones chain to admin — before the reveal. See ../DESIGN.md
row 03. -->
