...
bridge arrives as a blast-radius prediction the learner commits to before the reveal, then as an
audit→build lab that ends in the fix proven as code. Learn is richer than module 01 — this is a
specialist module, so it curates more. See ../DESIGN.md row 02. -->
