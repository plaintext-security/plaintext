...
<!-- module-meta -->
**Difficulty:** Intermediate &nbsp;·&nbsp; **Estimated time:** ~4–6 hrs (study + lab) &nbsp;·&nbsp; **Prerequisites:** [Foundations](../../../00-foundations/README.md) · [Module 08 — CI/CD Pipeline Security](../08-cicd-pipeline-security/README.md)
{ .module-meta }

<!-- AUTHOR'S NOTE (delete before publish): Variant-D form. No front-loaded "core idea" essay; the
bridge arrives as a predict-then-reveal verdict — the learner calls what's hidden in a working image
before the scan reveals it — then the lab makes the hardened multi-stage rebuild an explicit graded
step (rebalance minor). Learn curates the scanner mechanism; the spine is the trust argument. See
../DESIGN.md row 10. -->
