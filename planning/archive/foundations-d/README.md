# Track 00 — Foundations *(Verdict rewrite)*

> **Experimental parallel rewrite** of the shipped Foundations track, in the "Variant D" vein (see
> `../module-01-alternatives/` and `../cloud-track-d/`). Lives under `planning/` and builds nothing —
> the shipped track at `tracks/00-foundations/` stays in place. Read `DESIGN.md` for the spine.
...
*Anchors are real, public incidents and primary sources; see `DESIGN.md` for the per-module brief.*
