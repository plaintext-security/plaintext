...
| 11 | [Click-ops → IaC Migration](modules/11-clickops-iac-migration/README.md) | Adopt running, hand-built infra under IaC — incrementally, zero drift | `terraform`, `opentofu` |
